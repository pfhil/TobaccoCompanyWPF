...
namespace TobaccoCompanyWPF.ViewModels.ValidationAttributes
{
    ...
    public sealed class RequiredIfAttribute : ValidationAttribute
    {
        ...
        public RequiredIfAttribute(string otherProperty, object otherPropertyValue, [CallerMemberName] string propertyName = null)
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
                ...
                this.IsInverted && !object.Equals(otherValue, this.OtherPropertyValue))
            {
                if (value == null)
                {
                    return new ValidationResult(this.FormatErrorMessage(validationContext.DisplayName), new[] { this.PropertyName });
                }
